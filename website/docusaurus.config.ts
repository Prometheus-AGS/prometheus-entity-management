...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'v3_stable',
      content:
        '<strong>3.1.0 stable</strong> — all twelve npm packages are public on npm at 3.1.0, including the optional React DevTools inspector. Flutter 3.0.1 is public on pub.dev.',
