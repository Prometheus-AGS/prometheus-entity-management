...
| Flutter | Flutter 3.44.8 / Riverpod 3 | pub.dev `entity_graph_flutter@3.0.5`; official DevTools companion; A2UI 1.0-RC compatibility via GenUI 0.10.2 |
...
Flutter is a public stable `3.0.5` on pub.dev. React and A2UI React are public
