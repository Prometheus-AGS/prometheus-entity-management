...
> **Status:** the 3.0 line is complete. Stable `3.0.3` holds `latest` on all
> twelve npm packages (published 2026-08-24; the short-lived `3.0.0` stable
...
The rc.1 stage completed and stable `3.0.3` now holds `latest` on all twelve
