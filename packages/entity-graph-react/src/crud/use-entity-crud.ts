...
import type { ViewDescriptor, FilterSpec, SortSpec } from "@prometheus-ags/entity-graph-core";
import { collectDirtyPaths, setValueAtPath } from "@prometheus-ags/entity-graph-core";
