...
Version `3.1.0` includes an official package extension under
...
> This entry is included in `3.1.0`; `package:entity_graph_flutter/devtools.dart`
...
- The optional DevTools controller passed its complete
  ...
  versioned events. Version `3.1.0` also includes the official, validated
