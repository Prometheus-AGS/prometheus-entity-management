...
Desktop proof is not mobile proof. Android and iOS require the simulator/device procedure in [`release/tauri-mobile-device-lane.md`](../../release/tauri-mobile-device-lane.md); stable `3.0.0` remains blocked until those runtime artifacts are captured.
