...
description: >
  Add realtime synchronization to an existing prometheus-entity-management setup: detect the push source
...
Each route maps to `skills/entity-graph-realtime/skills/<name>/SKILL.md`.
...
```bash
bash skills/entity-graph-realtime/scripts/detect-orchestrators.sh
```
