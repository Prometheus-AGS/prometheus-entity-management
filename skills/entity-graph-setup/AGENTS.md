...
- Initialize session state: `bash skills/entity-graph-setup/scripts/state-init.sh <workspace_root>`
- Orchestrators: `bash skills/entity-graph-setup/scripts/detect-orchestrators.sh` (from workspace root; adjust path if skill is copied elsewhere)
