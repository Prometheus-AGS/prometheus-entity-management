...
```bash
bash skills/entity-graph-setup/scripts/detect-orchestrators.sh
```
...
- `skills/_shared/references/branding.md` (travisjames.ai tokens for examples)
- `skills/_shared/references/schemas/*.schema.json`
