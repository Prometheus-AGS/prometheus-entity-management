...
- `skills/_shared/references/architecture-rules.md` — non-negotiable layering.
- `skills/entity-graph-setup/references/migration-patterns.md` — strangler / parallel patterns.
- `skills/entity-graph-setup/references/codebase-analysis.md` — what to scan and in what order.
