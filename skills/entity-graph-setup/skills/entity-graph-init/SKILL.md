...
- `skills/_shared/references/library-api.md` — Engine + hooks entry points.
- `skills/_shared/references/architecture-rules.md` — Layering.
- Parent: `skills/entity-graph-setup/SKILL.md`
