...
1. Run checklist in `skills/entity-graph-setup/references/codebase-analysis.md`.
2. For each resource, emit one object validated against `skills/_shared/references/schemas/entity-types.schema.json`.
...
- `skills/entity-graph-setup/agents/analyzer.md` — role boundaries.
- `skills/_shared/references/schemas/relation-schema.schema.json` — relation JSON hints.
