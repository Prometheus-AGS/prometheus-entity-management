...
## Purpose
TBD - created by archiving change v3-nextjs-app-router-example. Update Purpose after archive.
## Requirements
...
- **WHEN** every task in `openspec/changes/v3-nextjs-app-router-example/tasks.md` is complete
