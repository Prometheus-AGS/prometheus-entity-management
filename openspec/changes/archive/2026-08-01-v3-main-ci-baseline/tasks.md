# Tasks: v3-main-ci-baseline

- [x] Confirm dependencies are complete: NONE.
- [x] Implement the full scope in the `v3-main-ci-baseline` plan section without weakening its explicit exclusions.
