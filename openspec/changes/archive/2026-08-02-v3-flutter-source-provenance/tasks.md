# Tasks: v3-flutter-source-provenance

- [x] Confirm dependencies are complete: v3-release-contract.
- [x] Implement the full scope in the `v3-flutter-source-provenance` plan section without weakening its explicit exclusions.
