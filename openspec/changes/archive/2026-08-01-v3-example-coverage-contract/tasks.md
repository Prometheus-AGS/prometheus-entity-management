# Tasks: v3-example-coverage-contract

- [x] Confirm dependencies are complete: v3-release-contract.
- [x] Implement the full scope in the `v3-example-coverage-contract` plan section without weakening its explicit exclusions.
