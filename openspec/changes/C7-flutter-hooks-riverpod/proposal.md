# Proposal: C7-flutter-hooks-riverpod — Flutter toolchain + hooks_riverpod

**Phase:** pem-refresh-3-3-0 (child of web-ui-architecture, prior-auth repo)
**Depends on:** —
**Recommended agent:** flutter-reviewer
**Model class:** frontier

## Why

Required by the `pem-refresh-3-3-0` plan. The authoritative scope, tasks,
verification commands and acceptance criteria are in the **C7-flutter-hooks-riverpod** section of:
...
- Implement exactly the tasks listed for C7-flutter-hooks-riverpod in that plan section.
