...
- [ ] Confirm dependencies are complete: v3-release-contract; v3-example-coverage-contract.
- [ ] Implement the full scope in the `v3-docs-foundation-brand` plan section without weakening its explicit exclusions.
