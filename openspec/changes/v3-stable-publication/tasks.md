# Tasks: v3-stable-publication

- [ ] Confirm dependencies are complete: v3-release-certification.
- [ ] Implement the full scope in the `v3-stable-publication` plan section without weakening its explicit exclusions.
