# Proposal: C1-alias-directory-decision — Decide the alias directory shape
...
verification commands and acceptance criteria are in the **C1-alias-directory-decision** section of:
...
- Implement exactly the tasks listed for C1-alias-directory-decision in that plan section.
