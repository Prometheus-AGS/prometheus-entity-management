# Proposal: C2-freeze-table-type-surface — Freeze the public table type surface
...
verification commands and acceptance criteria are in the **C2-freeze-table-type-surface** section of:
...
- Implement exactly the tasks listed for C2-freeze-table-type-surface in that plan section.
